public class SistemaTeste {
    public static void main(String[] args) {
        ...
        Vendas venda1 = new Vendas(cliente1, produto1, 1,vendedor1);
        Vendas venda2 = new Vendas(cliente2, produto2, 2,vendedor2);
        Vendas venda3 = new Vendas(cliente3, produto3, 3,vendedor3);
        ...
        Avaliacao avaliacao1=new Avaliacao(5,"odeio java");
